...
# Selections
double_soft_muon_muonpt.nmuons = cms.unit32(2)
...
double_soft_muon_muonpt.invMasscut       = cms.double(50)
# Binning
double_soft_muon_muonpt.muPtBinning      =cms.vdouble(0,2,5,7,10,12,15,17,20,25,30,50)
double_soft_muon_muonpt.muPtBinning2D     =cms.vdouble(0,2,5,7,10,12,15,17,20,25,30,50)
# Triggers
...
# Selections
double_soft_muon_metpt.nmuons = cms.unit32(2)
...
double_soft_muon_metpt.invMasscut       = cms.double(50)
# Binning
double_soft_muon_metpt.metPSet      =cms.PSet(nbins=cms.unit32(50),xmin=cms.double(50),xmax=cms.double(300) )
# Triggers
...
# Selections
double_soft_muon_mll.nmuons = cms.unit32(2)
...
# Selections
double_soft_muon_mhtpt.nmuons = cms.unit32(2)
...
double_soft_muon_mhtpt.invMasscut       = cms.double(50)
# Binning
